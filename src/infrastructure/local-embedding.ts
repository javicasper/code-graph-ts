...
// Singleton to avoid reloading model on every request
// @ts-ignore - FeatureExtractionPipeline type might be tricky with ESM/TS
...
export class LocalEmbeddingClient implements EmbeddingGenerator {
